...
Continent_data = pd.read_excel('Continent.xlsx')
Item_data = pd.read_excel('Item.xlsx')
Region_data = pd.read_excel('Region.xlsx')
Type_data = pd.read_excel('Type.xlsx')
Mode_data = pd.read_excel('Mode.xlsx')
Country_data = pd.read_excel('Country.xlsx')
